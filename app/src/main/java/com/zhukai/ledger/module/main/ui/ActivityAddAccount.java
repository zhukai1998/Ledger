...
public class ActivityAddAccount extends BaseActivity implements
        ...
        public View getView(final int position, View convertView,
            ...
            if (convertView == null) {
                ...
                convertView = inflater.inflate(
                        R.layout.dialog_calendar_gv_item,
                ...
                if (currentdayposition == currentDay) {// 列表项等于当前日期
                    ...
                    holder.tv
                            .setBackgroundResource(R.drawable.calendar_circlebg);
                }
            ...
            if (currentdayposition != currentDay && position >= firstDayOfWeek) {// 列表项等于当前日期
                ...
                if (sba_date.get(position)) {
                    ...
                    holder.tv
                            .setBackgroundResource(R.drawable.calendar_circlering);
    ...
    private void showDatePickerDialog() {
        ...
        View dilogview = layoutInflater.inflate(R.layout.dialog_calendar,
